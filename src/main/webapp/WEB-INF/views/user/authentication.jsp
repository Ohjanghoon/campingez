		...
		<div id="login">
			<div id="login_form">
				...
				<form>
 				...
 				<a class="modal_close_btn"><img src="${pageContext.request.contextPath}/resources/images/mypage/modalclose.png"
					 width="30px"></a>
			</div>
		</div>
	</div>
	...
	$.ajax({
		...
		success(response){
			...
			if(response.msg == "success"){
				  window.location.href= "${pageContext.request.contextPath}/userInfo/userInfo.do";
			}else{
				getImage();
